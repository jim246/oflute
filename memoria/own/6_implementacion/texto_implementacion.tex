...
Como se comentó en la planificación (\textit{\nameref{chap:calendario}}), la
...
El principal concepto en una API de sonido de bajo o medio nivel es el flujo de
...
a medias ciertos orificios. De este estudio se extrajeron los siguientes resultados.
...
Para evitar devolver resultados incorrectos, y com
